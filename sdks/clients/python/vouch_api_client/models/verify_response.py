...
class VerifyResponse(BaseModel):
    ...
    """ # noqa: E501
    is_valid: StrictBool
    signer_identity: Optional[Dict[str, Any]] = None
    signed_at: Optional[StrictStr] = None
    claim_generator: Optional[StrictStr] = None
    error: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["is_valid", "signer_identity", "signed_at", "claim_generator", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "signer_identity": obj.get("signer_identity"),
