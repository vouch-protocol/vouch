...
> **v1.0 alignment with open standards.** This guide reflects the current
> v1.0 specification which uses Verifiable Credentials secured by W3C
...
### D. Verifiable Credentials with Data Integrity (v1.0)
**Decision**: The Vouch credential is a VC secured by a W3C Data
Integrity proof using the `eddsa-jcs-2022` cryptosuite.
**Why**:
- **Standards alignment**: directly on the open-standard track, sharing primitives
