# PAD-073: Untrusted-Resolver Identity Routing via Self-Signed Route Records with Anti-Substitution Binding
...
**License:** Apache 2.0  
**Related:** PAD-001 (Cryptographic Agent Identity), PAD-005 (Detached Signature Recovery), PAD-072 (Trust-Preserving Transport Failover)  
...
- **Endpoint-route attestation, not content addressing or document publication.**
  ...
  accountability-bearing message envelope (see PAD-072).
