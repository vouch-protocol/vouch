...
const FOOTER_GROUPS = [
    ...
    },
    {
        ...
        links: [
            ...
            { label: 'W3C CG Report', href: 'https://github.com/vouch-protocol/vouch/blob/main/docs/specs/cg-report-executive-summary.md', external: true },
    ...
    },
    {
        ...
        links: [
            ...
            { label: 'W3C CCG mailing list', href: 'https://lists.w3.org/Archives/Public/public-credentials/', external: true },
            ...
            <div className="container-wide">
                <div className="double-rule pt-12">
                    ...
                    <div className="mt-12 pt-6 border-t border-rule flex flex-col md:flex-row gap-3 items-start md:items-center justify-between font-mono text-[0.7rem] tracking-[0.1em] text-ink-faint">
                        ...
                        <span>An open W3C-track specification.</span>
                    </div>
                </div>
            </div>
        </footer>
