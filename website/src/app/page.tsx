...
const FEATURES = [
    {
        ...
        body: 'Every agent holds a W3C Decentralized Identifier (did:web or did:key) backed by an Ed25519 keypair. No API keys, no shared secrets, no bearer tokens.',
        spec: '§6 Identity Model',
    },
    {
        num: 'ii.',
        title: 'Intent-bound Credentials',
        body: 'Every action is signed as a W3C Verifiable Credential with Data Integrity proofs. The credential binds identity, action, target, and resource so nothing replays elsewhere.',
...
const STANDARDS = [
    { label: 'W3C Verifiable Credentials 2.0', href: 'https://www.w3.org/TR/vc-data-model-2.0/' },
    { label: 'W3C Data Integrity', href: 'https://www.w3.org/TR/vc-data-integrity/' },
    { label: 'W3C DIDs', href: 'https://www.w3.org/TR/did-core/' },
    { label: 'W3C Controlled Identifiers (Multikey)', href: 'https://www.w3.org/TR/controlled-identifiers/' },
    { label: 'W3C BitstringStatusList', href: 'https://www.w3.org/TR/vc-bitstring-status-list/' },
            ...
            <section className="border-b border-rule">
                <div className="container-wide py-20 md:py-28">
                    ...
                    <p className="drop-cap text-[1.2rem] leading-snug text-ink-soft max-w-prose mb-8">
                        The Vouch Protocol is an open, W3C-track specification for establishing continuous state
                        verifiability of autonomous AI agents, a layer that sits beneath, and complements, agent
                        identity and delegation specifications. Built on W3C Verifiable Credentials, Data Integrity
