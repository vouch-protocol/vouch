            ...
            <div className="container-wide py-20 md:py-28">
                ...
                <div className="max-w-prose text-ink-soft leading-relaxed space-y-5 text-[1.05rem]">
                    ...
                    <ol className="list-decimal pl-6 space-y-3">
                        ...
                        <li>For each domain we tried to resolve a did:web identity, meaning we fetched the standard identity document the domain would publish if it had one, using the Vouch Protocol&apos;s own resolver. We look beyond the standard location too. If it is empty, we read the agent&apos;s published card and resolve any identity it declares there, including a did:web served from a path rather than the root, or a self-contained did:key, so an agent that publishes identity in a less common but still valid place is counted rather than missed. The Index is therefore also a live test that Vouch verification works at internet scale.</li>
                        ...
                        <li>We checked our own work before trusting any number. We confirmed the scorer gives a perfect A to a domain that genuinely publishes an identity (we tested it against real ones in the wild), so the board is not stuck on F because of a bug. That check caught a real mistake: our first version only recognised one of the two common key formats and would have under-scored a genuine agent. We fixed it and re-checked.</li>
