...
const CHANNELS = [
    {
        ...
        secondary: { label: 'Archives', href: 'https://lists.w3.org/Archives/Public/public-credentials/' },
    },
    {
...
const QUICK_LINKS = [
    ...
    { label: 'W3C CG Report', href: 'https://github.com/vouch-protocol/vouch/blob/main/docs/specs/w3c-cg-report.md', external: true, body: 'The full specification draft.' },
