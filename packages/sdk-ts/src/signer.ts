...
export class Signer {
    ...
    // (W3C CG Report §13.2). Independent of any other PQ key the caller may
    ...
    /**
     * Canonical verification method ID for this signer (W3C CG Report §5.5).
     */
    ...
    /**
     * Public key in W3C Multikey format (z-prefixed base58btc, with the
     ...
     *
     * Implements the v1.0 issuance path per W3C CG Report §5 and §7.1.
     ...
     * (W3C CG Report §13.2). The credential carries a
    ...
    /**
     * ML-DSA-44 public key encoded as a W3C Multikey string
