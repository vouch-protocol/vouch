"""
Example: Sign a Vouch Credential (v1.6+, VC + Data Integrity).
...
def main() -> None:
    ...
    # in v1.0 (Specification §5.4.1). The resource binding prevents
    ...
    #
    # The legacy Content-Type "application/vouch+credential+json" remains
