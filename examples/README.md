...
| [robotics_ai_act_evidence_pack.py](robotics_ai_act_evidence_pack.py) | Assembles robot credentials into an EU AI Act high-risk evidence pack and signs a conformance attestation. | `python robotics_ai_act_evidence_pack.py` |
