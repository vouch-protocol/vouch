...
def sign_from_bytes():
    ...
    signed_bytes = client.sign_bytes(data=binary_data, filename="data.bin", origin="memory-signer")
...
def sign_from_stream():
    ...
    signed_bytes = client.sign_bytes(data=stream, filename="streamed.txt", origin="stream-signer")
