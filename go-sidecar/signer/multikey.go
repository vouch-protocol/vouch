...
//
// Mirrors vouch/multikey.py and typescript/src/multikey.ts. Per the W3C
...
//
// Supported algorithms (W3C CG Report §13.5):
//
...
// string. Used in the hybrid post-quantum profile (W3C CG Report §13.2).
