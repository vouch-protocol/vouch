...
Vouch ships nineteen robotics capabilities in `vouch.robotics` (and in TypeScript, Go,
...
every fused input back to a frame in the robot's signed perception log). Same
