...
Per the W3C Controlled Identifiers specification, public keys in DID Documents
...
Supported algorithms (Vouch Protocol W3C CG Report §13.5):
...
def encode_mldsa44_public(raw_key: bytes) -> str:
    ...
    Used in the hybrid post-quantum profile (W3C CG Report §13.2). The
