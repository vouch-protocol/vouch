...
SHORTLINK_DOMAIN: Final[str] = os.getenv("VOUCH_SHORTLINK_DOMAIN", "https://vch.sh")

# Full verification domain where content is actually served
# All SEO value flows here
VERIFY_DOMAIN: Final[str] = os.getenv("VOUCH_VERIFY_DOMAIN", "https://vouch-protocol.com")

# Verification path prefix on the main domain
VERIFY_PATH: Final[str] = os.getenv("VOUCH_VERIFY_PATH", "/v")
...
API_DOMAIN: Final[str] = os.getenv("VOUCH_API_DOMAIN", "https://api.vouch-protocol.com")
