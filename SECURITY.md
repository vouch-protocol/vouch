...
- **Credential format (v1.0)**: W3C Verifiable Credentials secured by W3C Data Integrity proofs. JCS canonicalization (RFC 8785) produces a deterministic byte representation before hashing and signing.
